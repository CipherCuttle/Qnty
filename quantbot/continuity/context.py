...
def _validate_h001_calibration_implementation_blocked_handoff(receipt: dict, root: Path) -> None:
    ...
    if receipt["source_branch"] != "chore/h001-calibration-engine-implementation-block-v2" or receipt["source_head_commit"] != _H001_CALIBRATION_IMPLEMENTATION_BLOCKED_BASE_SHA:
