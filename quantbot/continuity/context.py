...
def _validate_h001_assurance_review_complete_handoff(receipt: dict, root: Path) -> None:
    ...
    expected_binding = {
        ...
        "review_packet_path": _H001_ASSURANCE_PACKET_RELPATH, "review_packet_sha256": hashlib.sha256((root / _H001_ASSURANCE_PACKET_RELPATH).read_bytes()).hexdigest(),
    ...
    required_decisions = {
        ...
        f"H001_REVIEW_EVIDENCE_PACKET_VERDICT={_H001_ASSURANCE_FINAL_VERDICT}",
        "H001_REVIEW_PACKET_PRIVATE_REASONING_INCLUSION=FALSE", "H001_REVIEW_PACKET_REAL_DATA_INCLUSION=FALSE",
        "H001_REVIEW_PACKET_SECRET_INCLUSION=FALSE", "H001_TEMPORAL_CAUSALITY_AMENDMENT_IMPLEMENTATION_FOR_REVIEW=AUTHORIZED",
        "H001_TEMPORAL_CAUSALITY_AMENDMENT_EFFECTIVE=FALSE", "H001_TEMPORAL_CAUSALITY_CURRENT_CONTRACT=UNCHANGED",
        "H001_SYNTHETIC_NULL_CALIBRATION_SPEC_FREEZE=NOT_AUTHORIZED", "H001_SYNTHETIC_NULL_CALIBRATION_RESULTS=NONE",
        "H001_SYNTHETIC_NULL_CALIBRATION_EXECUTION=NOT_AUTHORIZED", "GLOBAL_REAL_PROTOCOL_HOLDOUT_LEDGER_STATE=EMPTY_NO_BACKFILL",
        "H001_CANDIDATE_STORE_ACCESS_OR_PROBING=FORBIDDEN", "H001_SYNTHETIC_ARTIFACT_CANARY_SCAFFOLD=IMPLEMENTED_NOT_EXECUTED",
        "H001_REAL_DATA_ACCESS=FORBIDDEN", "H001_CURRENT_EXECUTION_BUDGET=0", "H001_CURRENT_EXECUTION_COUNT=0",
        "H001_SCIENTIFIC_AUTHORIZATION=FALSE", "H001_PAPER_TRADE_AUTHORIZATION=FALSE", "H001_LIVE_AUTHORIZATION=FALSE",
        "V0_AVAILABILITY=UNAVAILABLE", "DURABLE_STORES=UNCONFIGURED", "EDGE_UNPROVEN", "BLOCK_LIVE_INTEGRATION",
    }
    if not required_decisions.issubset(set(receipt["decisions"])) or "H001_PRE_DATA_ASSURANCE_SCAFFOLD_REVIEW=REQUIRED_NOT_COMPLETED" in receipt["decisions"]:
        _fail("H001 assurance review-completion decisions drifted")
