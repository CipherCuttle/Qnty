...
def build_calibration_execution_plan(spec: object) -> NoReturn:
    ...
    as not effective. Neither refusal is weaker than the other: no execution
    plan object exists in this module at all.
    """
