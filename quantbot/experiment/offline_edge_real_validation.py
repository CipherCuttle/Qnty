...
__all__ = [
    ...
    "_build_descriptive_statistical_metadata_rows_v0_diagnostics",
    "_derive_descriptive_statistical_metadata_rows_v0_gate",
...
SIMULATED_EVENT_SCHEMA_LOCK_VERSION = "simulated-event-schema-lock-0.1"
SIMULATED_EVENT_SCHEMA_LOCK_SCOPE = (
    "FUTURE_SIMULATED_EVENT_SCHEMA_ONLY_NO_EVENTS_EMITTED"
)
SIMULATED_EVENT_SCHEMA_LOCK_DECLARED_DIAGNOSTIC_ONLY = (
    "SIMULATED_EVENT_SCHEMA_LOCK_DECLARED_DIAGNOSTIC_ONLY"
)
SIMULATED_EVENT_SCHEMA_LOCK_POLICY = (
    "DECLARE_EVENT_SCHEMA_ONLY_DO_NOT_EMIT_EVENTS_IN_THIS_LANE"
)
BLOCKED_BY_MATERIALIZED_RULE_ROWS_V0_GATE = "BLOCKED_BY_MATERIALIZED_RULE_ROWS_V0_GATE"
...
_ALLOWED_SIMULATED_EVENT_SCHEMA_KEYS = (
    "schema_version", "schema_kind", "run_id", "event_sequence_id",
    "source_rule_row_sequence_id", "symbol", "split_id", "split_partition",
    "event_time_utc", "source_decision_time_utc", "source_bar_time_utc",
    "source_funding_time_utc", "event_family", "event_variant",
    "event_revision", "event_trigger_name", "event_trigger_result",
    "event_action_name", "event_action_code", "event_metadata_only",
)
_REQUIRED_SIMULATED_EVENT_SCHEMA_KEYS = (
    "schema_version", "schema_kind", "run_id", "event_sequence_id",
    "source_rule_row_sequence_id", "symbol", "split_id", "split_partition",
    "event_time_utc", "source_decision_time_utc", "event_family",
    "event_revision", "event_trigger_name", "event_trigger_result",
    "event_action_name", "event_action_code",
)
_FORBIDDEN_SIMULATED_EVENT_SCHEMA_KEY_NAMES = (
    "pnl", "return", "returns", "sharpe", "edge", "risk", "drawdown",
    "equity", "score", "metric", "performance", "profit", "p_value",
...
# === Lane V1: neutral economic accounting row artifacts ===
ECONOMIC_ACCOUNTING_ROWS_V0_VERSION = "economic-accounting-rows-v0-0.1"
ECONOMIC_ACCOUNTING_ROWS_V0_SCOPE = "NEUTRAL_ACCOUNTING_ROW_ARTIFACT_ONLY_NO_RETURNS_OR_SCORING"
ECONOMIC_ACCOUNTING_ROWS_V0_DECLARED_ARTIFACT_ONLY = "ECONOMIC_ACCOUNTING_ROWS_V0_DECLARED_ARTIFACT_ONLY"
ECONOMIC_ACCOUNTING_ROWS_V0_POLICY = "EMIT_SCHEMA_LOCKED_NEUTRAL_ACCOUNTING_ROWS_ONLY_NO_RETURNS_OR_SCORING"
ECONOMIC_ACCOUNTING_ROWS_V0_SCHEMA_VERSION = "economic-accounting-rows-v0-0.1"
ECONOMIC_ACCOUNTING_ROWS_V0_SCHEMA_KIND = "economic_accounting_row_v0"
ECONOMIC_ACCOUNTING_ROWS_V0_FAMILY = "neutral_event_accounting_v0"
ECONOMIC_ACCOUNTING_ROWS_V0_VARIANT = "noop_event_neutral_amount"
ECONOMIC_ACCOUNTING_ROWS_V0_REVISION = "v1-0.1"
ECONOMIC_ACCOUNTING_ROWS_V0_MAX_ROWS = 100
ECONOMIC_ACCOUNTING_ROWS_V0_NEUTRAL_AMOUNT_VALUE = 0
BLOCKED_BY_ECONOMIC_OUTPUT_SCHEMA_LOCK_GATE = "BLOCKED_BY_ECONOMIC_OUTPUT_SCHEMA_LOCK_GATE"
BLOCKED_BY_INCOMPLETE_ECONOMIC_ACCOUNTING_ROWS_V0_EVIDENCE = "BLOCKED_BY_INCOMPLETE_ECONOMIC_ACCOUNTING_ROWS_V0_EVIDENCE"
BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_ROW_SCHEMA = "BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_ROW_SCHEMA"
BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_FORBIDDEN_KEY = "BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_FORBIDDEN_KEY"
BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_FORBIDDEN_VALUE = "BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_FORBIDDEN_VALUE"
BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_NON_NEUTRAL_AMOUNT = "BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_NON_NEUTRAL_AMOUNT"
BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_DOWNSTREAM_OUTPUT = "BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_DOWNSTREAM_OUTPUT"
BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_DOWNSTREAM_AUTHORIZATION = "BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_DOWNSTREAM_AUTHORIZATION"
_ECONOMIC_ACCOUNTING_ROWS_V0_FORBIDDEN_NAMES = frozenset(
    set(_FORBIDDEN_ECONOMIC_OUTPUT_SCHEMA_KEY_NAMES)
    | {"close", "fundingRate", "open", "high", "low", "volume", "markPrice", "price_value", "funding_value", "cost", "costs", "fee", "fees"}
)
_ECONOMIC_ACCOUNTING_ROWS_V0_DOWNSTREAM_OUTPUT_FIELDS = (
    "price_values_emitted", "funding_rate_values_emitted", "cost_values_emitted",
...
# === Lane Y1: statistical value-readiness evidence rows ===
STATISTICAL_VALUE_READINESS_ROWS_V0_VERSION = "statistical-value-readiness-rows-v0-0.1"
STATISTICAL_VALUE_READINESS_ROWS_V0_SCOPE = "METADATA_ONLY_STATISTICAL_VALUE_READINESS_ROWS_NO_VALUES_EMITTED"
STATISTICAL_VALUE_READINESS_ROWS_V0_DECLARED_ARTIFACT_ONLY = "STATISTICAL_VALUE_READINESS_ROWS_V0_DECLARED_ARTIFACT_ONLY"
STATISTICAL_VALUE_READINESS_ROWS_V0_SCHEMA_VERSION = "statistical-value-readiness-rows-v0-0.1"
STATISTICAL_VALUE_READINESS_ROWS_V0_SCHEMA_KIND = "statistical_value_readiness_row_v0"
STATISTICAL_VALUE_READINESS_ROWS_V0_MAX_ROWS = 100
BLOCKED_BY_STATISTICAL_VALUE_CONTRACT_LOCK_Y0_FOR_Y1_GATE = "BLOCKED_BY_STATISTICAL_VALUE_CONTRACT_LOCK_Y0_FOR_Y1_GATE"
BLOCKED_BY_STATISTICAL_METADATA_ROWS_V0_FOR_Y1_GATE = "BLOCKED_BY_STATISTICAL_METADATA_ROWS_V0_FOR_Y1_GATE"
BLOCKED_BY_STATISTICAL_OUTPUT_SCHEMA_LOCK_X0_FOR_Y1_GATE = "BLOCKED_BY_STATISTICAL_OUTPUT_SCHEMA_LOCK_X0_FOR_Y1_GATE"
BLOCKED_BY_NULL_REFERENCE_COMPARISON_ROWS_V0_FOR_Y1_GATE = "BLOCKED_BY_NULL_REFERENCE_COMPARISON_ROWS_V0_FOR_Y1_GATE"
BLOCKED_BY_NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_FOR_Y1_GATE = "BLOCKED_BY_NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_FOR_Y1_GATE"
BLOCKED_BY_ECONOMIC_ACCOUNTING_ROWS_V0_FOR_Y1_GATE = "BLOCKED_BY_ECONOMIC_ACCOUNTING_ROWS_V0_FOR_Y1_GATE"
BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_UPSTREAM_GATE = "BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_UPSTREAM_GATE"
BLOCKED_BY_INCOMPLETE_STATISTICAL_VALUE_READINESS_ROWS_V0_EVIDENCE = "BLOCKED_BY_INCOMPLETE_STATISTICAL_VALUE_READINESS_ROWS_V0_EVIDENCE"
BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_ROW_SCHEMA = "BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_ROW_SCHEMA"
BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_ROW_CONSTANTS = "BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_ROW_CONSTANTS"
BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUE_READINESS_VALUE = "BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUE_READINESS_VALUE"
BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_Y1 = "BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_Y1"
BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_INFERENTIAL_OUTPUT = "BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_INFERENTIAL_OUTPUT"
BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_DOWNSTREAM_OUTPUT = "BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_DOWNSTREAM_OUTPUT"
BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_DOWNSTREAM_AUTHORIZATION = "BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_DOWNSTREAM_AUTHORIZATION"
BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_FINAL_VERDICT_ADVANCEMENT = "BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_FINAL_VERDICT_ADVANCEMENT"
BLOCKED_BY_DUPLICATE_STATISTICAL_VALUE_READINESS_ROW_IDENTITY = "BLOCKED_BY_DUPLICATE_STATISTICAL_VALUE_READINESS_ROW_IDENTITY"
BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROW_ORDERING_MUTATION = "BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROW_ORDERING_MUTATION"
BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROW_SOURCE_COUNT_MISMATCH = "BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROW_SOURCE_COUNT_MISMATCH"
BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROW_CAP_EXCEEDED = "BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROW_CAP_EXCEEDED"
_ALLOWED_STATISTICAL_VALUE_READINESS_ROW_KEYS = (
    "schema_version", "schema_kind", "run_id", "readiness_sequence_id",
    "source_statistical_sequence_id", "source_comparison_sequence_id",
    "source_accounting_sequence_id", "source_event_sequence_id",
    "source_rule_row_sequence_id", "symbol", "split_id", "split_partition",
    "readiness_time_utc", "source_statistical_time_utc",
    "source_comparison_time_utc", "source_accounting_time_utc",
    "source_event_time_utc", "readiness_family", "readiness_variant",
    "readiness_revision", "readiness_entry_name", "readiness_entry_code",
    "readiness_basis_name", "readiness_basis_code", "readiness_unit",
    "readiness_value_kind", "readiness_value_present", "readiness_value",
    "readiness_metadata_only",
)
_STATISTICAL_VALUE_READINESS_ROWS_V0_FIXED_ROW_CONSTANTS = {
    "schema_version": STATISTICAL_VALUE_READINESS_ROWS_V0_SCHEMA_VERSION,
    "schema_kind": STATISTICAL_VALUE_READINESS_ROWS_V0_SCHEMA_KIND,
    "readiness_family": "neutral_statistical_value_readiness_v0",
    "readiness_variant": "noop_no_statistical_value",
    "readiness_revision": "y1-0.1",
    "readiness_entry_name": "metadata_only_value_readiness_artifact",
    "readiness_entry_code": "NOOP_VALUE_READINESS_METADATA_ONLY",
    "readiness_basis_name": "schema_locked_statistical_metadata_row_projection",
    "readiness_basis_code": "STATISTICAL_METADATA_ONLY",
    "readiness_unit": "unitless",
    "readiness_value_kind": "not_computed",
}
...
# === Lane Z1: descriptive statistical metadata rows ===
DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_VERSION = "descriptive-statistical-metadata-rows-v0-0.1"
DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_SCOPE = "METADATA_ONLY_DESCRIPTIVE_STATISTICAL_ROWS_NO_VALUES_EMITTED"
DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_DECLARED_ARTIFACT_ONLY = "DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_DECLARED_ARTIFACT_ONLY"
DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_SCHEMA_VERSION = "descriptive-statistical-metadata-rows-v0-0.1"
DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_SCHEMA_KIND = "descriptive_statistical_metadata_row_v0"
DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_MAX_ROWS = 100
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_FOR_Z1_GATE = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_FOR_Z1_GATE"
BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_FOR_Z1_GATE = "BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_FOR_Z1_GATE"
BLOCKED_BY_STATISTICAL_VALUE_CONTRACT_LOCK_Y0_FOR_Z1_GATE = "BLOCKED_BY_STATISTICAL_VALUE_CONTRACT_LOCK_Y0_FOR_Z1_GATE"
BLOCKED_BY_STATISTICAL_METADATA_ROWS_V0_FOR_Z1_GATE = "BLOCKED_BY_STATISTICAL_METADATA_ROWS_V0_FOR_Z1_GATE"
BLOCKED_BY_STATISTICAL_OUTPUT_SCHEMA_LOCK_X0_FOR_Z1_GATE = "BLOCKED_BY_STATISTICAL_OUTPUT_SCHEMA_LOCK_X0_FOR_Z1_GATE"
BLOCKED_BY_NULL_REFERENCE_COMPARISON_ROWS_V0_FOR_Z1_GATE = "BLOCKED_BY_NULL_REFERENCE_COMPARISON_ROWS_V0_FOR_Z1_GATE"
BLOCKED_BY_NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_FOR_Z1_GATE = "BLOCKED_BY_NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_FOR_Z1_GATE"
BLOCKED_BY_ECONOMIC_ACCOUNTING_ROWS_V0_FOR_Z1_GATE = "BLOCKED_BY_ECONOMIC_ACCOUNTING_ROWS_V0_FOR_Z1_GATE"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_UPSTREAM_GATE = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_UPSTREAM_GATE"
BLOCKED_BY_INCOMPLETE_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_EVIDENCE = "BLOCKED_BY_INCOMPLETE_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_EVIDENCE"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_ROW_SCHEMA = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_ROW_SCHEMA"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_ROW_CONSTANTS = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_ROW_CONSTANTS"
BLOCKED_BY_UNEXPECTED_EMITTED_DESCRIPTIVE_STATISTICAL_METADATA_VALUE = "BLOCKED_BY_UNEXPECTED_EMITTED_DESCRIPTIVE_STATISTICAL_METADATA_VALUE"
BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_Z1 = "BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_Z1"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_INFERENTIAL_OUTPUT = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_INFERENTIAL_OUTPUT"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_DOWNSTREAM_OUTPUT = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_DOWNSTREAM_OUTPUT"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_DOWNSTREAM_AUTHORIZATION = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_DOWNSTREAM_AUTHORIZATION"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FINAL_VERDICT_ADVANCEMENT = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FINAL_VERDICT_ADVANCEMENT"
BLOCKED_BY_DUPLICATE_DESCRIPTIVE_STATISTICAL_METADATA_ROW_IDENTITY = "BLOCKED_BY_DUPLICATE_DESCRIPTIVE_STATISTICAL_METADATA_ROW_IDENTITY"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROW_ORDERING_MUTATION = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROW_ORDERING_MUTATION"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROW_SOURCE_COUNT_MISMATCH = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROW_SOURCE_COUNT_MISMATCH"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROW_CAP_EXCEEDED = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROW_CAP_EXCEEDED"
_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FIXED_ROW_CONSTANTS = {
    "schema_version": DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_SCHEMA_VERSION,
    "schema_kind": DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_SCHEMA_KIND,
    "descriptive_family": "neutral_descriptive_statistical_metadata_v0",
    "descriptive_variant": "noop_no_descriptive_value",
    "descriptive_revision": "z1-0.1",
    "descriptive_entry_name": "metadata_only_descriptive_statistical_artifact",
    "descriptive_entry_code": "NOOP_DESCRIPTIVE_METADATA_ONLY",
    "descriptive_basis_name": "schema_locked_readiness_row_projection",
    "descriptive_basis_code": "READINESS_METADATA_ONLY",
    "descriptive_unit": "unitless",
    "descriptive_value_kind": "not_computed",
}
_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_Z1_UPSTREAM_GATE_FIELDS = _DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_UPSTREAM_GATE_FIELDS
_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_Z1_OUTPUT_FIELDS = _DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_OUTPUT_FIELDS
_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_Z1_AUTHORIZATION_FIELDS = _DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_AUTHORIZATION_FIELDS

# === Lane AA0: descriptive statistical value policy lock diagnostics ===
DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_VERSION = "descriptive-statistical-value-policy-lock-aa0-0.1"
DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_SCOPE = "FUTURE_DESCRIPTIVE_METADATA_COUNTS_ONLY_NO_VALUES_EMITTED"
DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_DECLARED_DIAGNOSTIC_ONLY = "DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_DECLARED_DIAGNOSTIC_ONLY"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FOR_AA0_GATE = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FOR_AA0_GATE"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_FOR_AA0_GATE = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_FOR_AA0_GATE"
BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_FOR_AA0_GATE = "BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_FOR_AA0_GATE"
BLOCKED_BY_STATISTICAL_VALUE_CONTRACT_LOCK_Y0_FOR_AA0_GATE = "BLOCKED_BY_STATISTICAL_VALUE_CONTRACT_LOCK_Y0_FOR_AA0_GATE"
BLOCKED_BY_STATISTICAL_METADATA_ROWS_V0_FOR_AA0_GATE = "BLOCKED_BY_STATISTICAL_METADATA_ROWS_V0_FOR_AA0_GATE"
BLOCKED_BY_STATISTICAL_OUTPUT_SCHEMA_LOCK_X0_FOR_AA0_GATE = "BLOCKED_BY_STATISTICAL_OUTPUT_SCHEMA_LOCK_X0_FOR_AA0_GATE"
BLOCKED_BY_NULL_REFERENCE_COMPARISON_ROWS_V0_FOR_AA0_GATE = "BLOCKED_BY_NULL_REFERENCE_COMPARISON_ROWS_V0_FOR_AA0_GATE"
BLOCKED_BY_NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_FOR_AA0_GATE = "BLOCKED_BY_NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_FOR_AA0_GATE"
BLOCKED_BY_ECONOMIC_ACCOUNTING_ROWS_V0_FOR_AA0_GATE = "BLOCKED_BY_ECONOMIC_ACCOUNTING_ROWS_V0_FOR_AA0_GATE"
...
BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_AA0 = "BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_AA0"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_INFERENTIAL_OUTPUT = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_INFERENTIAL_OUTPUT"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_DOWNSTREAM_OUTPUT = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_DOWNSTREAM_OUTPUT"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_DOWNSTREAM_AUTHORIZATION = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_DOWNSTREAM_AUTHORIZATION"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_FINAL_VERDICT_ADVANCEMENT = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_FINAL_VERDICT_ADVANCEMENT"
_ALLOWED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_KEYS_AA0 = (
    "policy_version", "policy_kind", "source_row_schema_kind", "source_row_schema_version",
    "source_metadata_row_kind", "allowed_future_descriptive_value_kind_names",
...
# === Lane AA1: policy-applied descriptive count values ===
DESCRIPTIVE_COUNT_VALUES_V0_VERSION = "descriptive-count-values-v0-0.1"
DESCRIPTIVE_COUNT_VALUES_V0_SCOPE = "AA0_POLICY_APPLIED_METADATA_COUNT_VALUES_ONLY"
DESCRIPTIVE_COUNT_VALUES_V0_DECLARED_ARTIFACT = "DESCRIPTIVE_COUNT_VALUES_V0_DECLARED_ARTIFACT"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_FOR_AA1_GATE = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_FOR_AA1_GATE"
BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FOR_AA1_GATE = "BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FOR_AA1_GATE"
BLOCKED_BY_DESCRIPTIVE_COUNT_VALUES_V0_UPSTREAM_GATE = "BLOCKED_BY_DESCRIPTIVE_COUNT_VALUES_V0_UPSTREAM_GATE"
BLOCKED_BY_DESCRIPTIVE_COUNT_VALUES_V0_POLICY_LITERAL = "BLOCKED_BY_DESCRIPTIVE_COUNT_VALUES_V0_POLICY_LITERAL"
BLOCKED_BY_INCOMPLETE_DESCRIPTIVE_COUNT_VALUES_V0_EVIDENCE = "BLOCKED_BY_INCOMPLETE_DESCRIPTIVE_COUNT_VALUES_V0_EVIDENCE"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_KIND_MUTATION = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_KIND_MUTATION"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_ROW_SCHEMA = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_ROW_SCHEMA"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_ROW_CONSTANTS = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_ROW_CONSTANTS"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_ROW_KIND = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_ROW_KIND"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE"
BLOCKED_BY_DESCRIPTIVE_COUNT_VALUE_MISMATCH = "BLOCKED_BY_DESCRIPTIVE_COUNT_VALUE_MISMATCH"
BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_AA1 = "BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_AA1"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_INFERENTIAL_OUTPUT = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_INFERENTIAL_OUTPUT"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_DOWNSTREAM_OUTPUT = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_DOWNSTREAM_OUTPUT"
BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_DOWNSTREAM_AUTHORIZATION = "BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_COUNT_VALUE_DOWNSTREAM_AUTHORIZATION"
BLOCKED_BY_DESCRIPTIVE_COUNT_VALUES_V0_FINAL_VERDICT_ADVANCEMENT = "BLOCKED_BY_DESCRIPTIVE_COUNT_VALUES_V0_FINAL_VERDICT_ADVANCEMENT"
BLOCKED_BY_DUPLICATE_DESCRIPTIVE_COUNT_VALUE_ROW_IDENTITY = "BLOCKED_BY_DUPLICATE_DESCRIPTIVE_COUNT_VALUE_ROW_IDENTITY"
BLOCKED_BY_DESCRIPTIVE_COUNT_VALUE_ROW_ORDERING_MUTATION = "BLOCKED_BY_DESCRIPTIVE_COUNT_VALUE_ROW_ORDERING_MUTATION"
_ALLOWED_DESCRIPTIVE_COUNT_VALUE_KIND_NAMES_AA1 = (
    "source_metadata_row_count", "source_symbol_count", "source_split_partition_count",
)
_DESCRIPTIVE_COUNT_VALUES_V0_FIXED_ROW_CONSTANTS = {
    "schema_version": DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_SCHEMA_VERSION,
    "schema_kind": DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_SCHEMA_KIND,
    "descriptive_family": "policy_applied_descriptive_count_values_v0",
    "descriptive_variant": "aa0_allowed_metadata_counts_only",
    "descriptive_revision": "aa1-0.1",
    "descriptive_entry_name": "policy_applied_metadata_count_value",
    "descriptive_entry_code": "AA0_ALLOWED_METADATA_COUNT",
    "descriptive_basis_name": "aa0_policy_applied_to_z1_metadata_rows",
    "descriptive_basis_code": "AA0_POLICY_Z1_METADATA_COUNTS",
    "descriptive_unit": "count",
}
...
def _build_simulated_event_schema_lock_diagnostics(
    *,
    ...
    """Build pure Lane U0 schema-only diagnostics; it emits no events."""
    def passed(section: dict[str, Any], gate_name: str) -> bool:
        gate = section.get(gate_name)
        return bool(gate is not None and gate.get("gate_passed") is True)

    diagnostics: dict[str, Any] = {
        "diagnostic_kind": "simulated_event_schema_lock",
        "simulated_event_schema_lock_version": SIMULATED_EVENT_SCHEMA_LOCK_VERSION,
        "simulated_event_schema_lock_scope": SIMULATED_EVENT_SCHEMA_LOCK_SCOPE,
        "simulated_event_schema_lock_status": (
            SIMULATED_EVENT_SCHEMA_LOCK_DECLARED_DIAGNOSTIC_ONLY
        ),
        "materialized_rule_rows_v0_gate_required": True,
        ...
        "simulated_event_schema_declared": True,
        "simulated_event_schema_mode": "SCHEMA_ONLY",
        "simulated_event_schema_policy": SIMULATED_EVENT_SCHEMA_LOCK_POLICY,
        "allowed_simulated_event_schema_keys": list(_ALLOWED_SIMULATED_EVENT_SCHEMA_KEYS),
        "required_simulated_event_schema_keys": list(_REQUIRED_SIMULATED_EVENT_SCHEMA_KEYS),
        "forbidden_simulated_event_key_names": list(
            _FORBIDDEN_SIMULATED_EVENT_SCHEMA_KEY_NAMES
        ),
        "simulated_events_emitted": False,
        "simulated_event_count": 0,
        "simulated_event_rows_emitted": False,
        "simulated_event_row_count": 0,
        "economic_values_emitted": False,
        "statistical_values_emitted": False,
        "null_comparison_values_emitted": False,
        "scoring_values_emitted": False,
        ...
        "final_verdict_values_emitted": False,
        "simulated_event_schema_readiness": False,
        "implementation_authorized": False,
        "runner_implementation_authorized": False,
        "rule_materialization_authorized": True,
        "simulated_event_generation_authorized": False,
    ...
    diagnostics["simulated_event_schema_lock_gate"] = (
        _derive_simulated_event_schema_lock_gate(diagnostics)
    )
    return diagnostics


def _derive_simulated_event_schema_lock_gate(
    diagnostics: dict[str, Any],
) -> dict[str, Any]:
    """Derive the U0 gate and fail closed on every non-schema-only mutation."""
    allowed = diagnostics.get("allowed_simulated_event_schema_keys")
    required = diagnostics.get("required_simulated_event_schema_keys")
    forbidden = diagnostics.get("forbidden_simulated_event_key_names")
    key_collisions = _find_forbidden_contract_dict_keys(diagnostics)
    upstream_fields = (
        "materialized_rule_rows_v0_gate_passed",
        "materialized_rule_row_schema_lock_gate_passed",
        "no_output_runner_dry_harness_gate_passed",
        "projected_input_joinability_gate_passed",
        "projected_input_temporal_sequence_gate_passed",
    ...
    evidence = {
        **{field: diagnostics.get(field) for field in upstream_fields},
        "schema_declared": diagnostics.get("simulated_event_schema_declared") is True,
        "schema_mode_matches": diagnostics.get("simulated_event_schema_mode") == "SCHEMA_ONLY",
        "schema_status_matches": diagnostics.get("simulated_event_schema_lock_status") == SIMULATED_EVENT_SCHEMA_LOCK_DECLARED_DIAGNOSTIC_ONLY,
        "schema_policy_matches": diagnostics.get("simulated_event_schema_policy") == SIMULATED_EVENT_SCHEMA_LOCK_POLICY,
        "allowed_schema_keys_match": allowed == list(_ALLOWED_SIMULATED_EVENT_SCHEMA_KEYS),
        "required_schema_keys_match": required == list(_REQUIRED_SIMULATED_EVENT_SCHEMA_KEYS),
        ...
        "forbidden_key_names_declared_as_safe_list": forbidden == list(_FORBIDDEN_SIMULATED_EVENT_SCHEMA_KEY_NAMES),
        "forbidden_dict_key_collisions_absent": not key_collisions,
        "simulated_event_count_zero": diagnostics.get("simulated_event_count") == 0,
        "simulated_event_row_count_zero": diagnostics.get("simulated_event_row_count") == 0,
    ...
    def gate(status: str, reason: str | None) -> dict[str, Any]:
        return {
            "gate_kind": "simulated_event_schema_lock_gate",
            "gate_scope": SIMULATED_EVENT_SCHEMA_LOCK_SCOPE,
            "gate_status": status,
            "gate_passed": False,
            "gate_scoring_authorization": False,
            "gate_live_authorization": False,
    ...
    if not diagnostics.get("no_output_runner_dry_harness_gate_passed"):
        return gate(BLOCKED_BY_NO_OUTPUT_RUNNER_DRY_HARNESS_GATE, "NO_OUTPUT_RUNNER_DRY_HARNESS_GATE_MISSING_OR_NOT_PASSED")
    if not diagnostics.get("projected_input_joinability_gate_passed"):
        return gate(BLOCKED_BY_PROJECTED_INPUT_JOINABILITY_GATE, "PROJECTED_INPUT_JOINABILITY_GATE_MISSING_OR_NOT_PASSED")
    offenders = [field for field in emission_fields if diagnostics.get(field) is True]
    if offenders or diagnostics.get("simulated_event_count") != 0 or diagnostics.get("simulated_event_row_count") != 0:
        return gate(BLOCKED_BY_UNEXPECTED_SIMULATED_EVENT_EMISSION, "UNEXPECTED_EMISSION_OR_NONZERO_EVENT_COUNT")
    offenders = [field for field in authorization_fields if diagnostics.get(field) is True]
    if offenders:
        return gate(BLOCKED_BY_UNEXPECTED_SIMULATED_EVENT_AUTHORIZATION, "UNEXPECTED_AUTHORIZATION_FIELDS_TRUE: " + ", ".join(sorted(offenders)))
    if not all(evidence.get(field) is True for field in upstream_fields) or not all(
        evidence.get(field) is True for field in (
            "schema_declared", "schema_mode_matches", "schema_status_matches",
            "schema_policy_matches", "allowed_schema_keys_match",
            "required_schema_keys_match", "required_schema_keys_subset_allowed",
            "forbidden_key_names_declared_as_safe_list",
            "forbidden_dict_key_collisions_absent", "simulated_event_count_zero",
            "simulated_event_row_count_zero", "rule_materialization_authorized",
        )
    ) or evidence["final_offline_verdict_remains"] != BLOCKED_BY_VALIDATION_IMPLEMENTATION:
        return gate(BLOCKED_BY_INCOMPLETE_SIMULATED_EVENT_SCHEMA_EVIDENCE, "SIMULATED_EVENT_SCHEMA_EVIDENCE_INCOMPLETE_OR_MUTATED")
    result = gate(SIMULATED_EVENT_SCHEMA_LOCK_DECLARED_DIAGNOSTIC_ONLY, None)
...
def _build_economic_accounting_rows_v0_diagnostics(
    *, economic_output_schema_lock_diagnostics: dict[str, Any],
    simulated_events_v0_diagnostics: dict[str, Any],
    simulated_event_schema_lock_diagnostics: dict[str, Any],
    materialized_rule_rows_v0_diagnostics: dict[str, Any],
    materialized_rule_row_schema_lock_diagnostics: dict[str, Any],
    ...
    """Build V1 rows solely from U1 event metadata with neutral-zero amounts."""
    def passed(section: dict[str, Any], gate_name: str) -> bool:
        gate = section.get(gate_name)
        return bool(isinstance(gate, dict) and gate.get("gate_passed") is True)

    upstream_sections = (
        ("economic_output_schema_lock", economic_output_schema_lock_diagnostics, "economic_output_schema_lock_gate"),
        ("simulated_events_v0", simulated_events_v0_diagnostics, "simulated_events_v0_gate"),
        ("simulated_event_schema_lock", simulated_event_schema_lock_diagnostics, "simulated_event_schema_lock_gate"),
        ("materialized_rule_rows_v0", materialized_rule_rows_v0_diagnostics, "materialized_rule_rows_v0_gate"),
        ("materialized_rule_row_schema_lock", materialized_rule_row_schema_lock_diagnostics, "materialized_rule_row_schema_lock_gate"),
    ...
    upstream = {f"{name}_gate_passed": passed(section, gate) for name, section, gate in upstream_sections}
    events = simulated_events_v0_diagnostics.get("simulated_events")
    events = events if isinstance(events, list) else []
    cap_exceeded = len(events) > ECONOMIC_ACCOUNTING_ROWS_V0_MAX_ROWS
    rows: list[dict[str, Any]] = []
    if all(upstream.values()) and not cap_exceeded:
        for sequence, event in enumerate(events, start=1):
            if not isinstance(event, dict):
                ...
                break
            rows.append({
                "schema_version": ECONOMIC_ACCOUNTING_ROWS_V0_SCHEMA_VERSION,
                "schema_kind": ECONOMIC_ACCOUNTING_ROWS_V0_SCHEMA_KIND,
                "run_id": event.get("run_id"), "accounting_sequence_id": sequence,
                "source_event_sequence_id": event.get("event_sequence_id"),
                "source_rule_row_sequence_id": event.get("source_rule_row_sequence_id"),
                "symbol": event.get("symbol"), "split_id": event.get("split_id"),
                "split_partition": event.get("split_partition"),
                "accounting_time_utc": event.get("event_time_utc"),
                "source_event_time_utc": event.get("event_time_utc"),
                "source_decision_time_utc": event.get("source_decision_time_utc"),
                "source_bar_time_utc": event.get("source_bar_time_utc"),
                "source_funding_time_utc": event.get("source_funding_time_utc"),
                "accounting_family": ECONOMIC_ACCOUNTING_ROWS_V0_FAMILY,
                "accounting_variant": ECONOMIC_ACCOUNTING_ROWS_V0_VARIANT,
                "accounting_revision": ECONOMIC_ACCOUNTING_ROWS_V0_REVISION,
                "accounting_entry_name": "neutral_artifact_entry",
                "accounting_entry_code": "NOOP_ACCOUNTING_ARTIFACT_ONLY",
                "accounting_basis_name": "schema_locked_noop_event",
                "accounting_basis_code": "EVENT_METADATA_ONLY", "accounting_unit": "unitless",
                "accounting_amount_kind": "neutral_zero",
                "accounting_amount_value": ECONOMIC_ACCOUNTING_ROWS_V0_NEUTRAL_AMOUNT_VALUE,
                "accounting_metadata_only": True,
            })
    diagnostics: dict[str, Any] = {
        "diagnostic_kind": "economic_accounting_rows_v0",
        "economic_accounting_rows_v0_version": ECONOMIC_ACCOUNTING_ROWS_V0_VERSION,
        "economic_accounting_rows_v0_scope": ECONOMIC_ACCOUNTING_ROWS_V0_SCOPE,
        "economic_accounting_rows_v0_status": ECONOMIC_ACCOUNTING_ROWS_V0_DECLARED_ARTIFACT_ONLY,
        **{f"{name}_gate_required": True for name, _, _ in upstream_sections}, **upstream,
        "economic_accounting_rows_v0_declared": True,
        "economic_accounting_rows_v0_mode": "SCHEMA_LOCKED_NEUTRAL_ACCOUNTING_ROW_ARTIFACT_ONLY",
        "economic_accounting_rows_v0_policy": ECONOMIC_ACCOUNTING_ROWS_V0_POLICY,
        "economic_output_rows_emitted": bool(rows), "economic_output_row_count": len(rows),
        "accounting_rows_emitted": bool(rows), "accounting_row_count": len(rows),
        "amount_values_emitted": bool(rows), "economic_values_emitted": bool(rows),
        "economic_accounting_rows": rows, "source_simulated_event_count": len(events),
        "accounting_row_count_matches_source_event_count": len(rows) == len(events),
        "accounting_schema_keys": list(_ALLOWED_ECONOMIC_OUTPUT_SCHEMA_KEYS),
        "accounting_schema_key_count": len(_ALLOWED_ECONOMIC_OUTPUT_SCHEMA_KEYS),
        "accounting_forbidden_key_names_absent": True, "accounting_forbidden_values_absent": True,
        "accounting_amount_values_all_neutral_zero": True, "accounting_non_neutral_amount_values_emitted": False,
        "simulated_event_cap_exceeded": cap_exceeded,
        **{field: False for field in _ECONOMIC_ACCOUNTING_ROWS_V0_DOWNSTREAM_OUTPUT_FIELDS},
        "rule_materialization_authorized": True, "simulated_event_generation_authorized": True,
        "economic_output_generation_authorized": True, "accounting_application_authorized": True,
        "amount_generation_authorized": True, "economic_value_generation_authorized": True,
        **{field: False for field in _ECONOMIC_ACCOUNTING_ROWS_V0_DOWNSTREAM_AUTHORIZATION_FIELDS},
        "economic_accounting_policy_diagnostics_present": isinstance(economic_accounting_policy_diagnostics, dict),
        "final_offline_verdict_remains": BLOCKED_BY_VALIDATION_IMPLEMENTATION,
    }
    diagnostics["economic_accounting_rows_v0_gate"] = _derive_economic_accounting_rows_v0_gate(diagnostics)
    return diagnostics


def _derive_economic_accounting_rows_v0_gate(diagnostics: dict[str, Any]) -> dict[str, Any]:
    """Fail closed unless V1 rows are exact, neutral, ordered U1 projections."""
    rows = diagnostics.get("economic_accounting_rows")
    rows_are_list = isinstance(rows, list)
    every_row_is_dict = rows_are_list and all(isinstance(row, dict) for row in rows)
    allowed_keys = set(_ALLOWED_ECONOMIC_OUTPUT_SCHEMA_KEYS)
    schema_exact = every_row_is_dict and all(set(row) == allowed_keys for row in rows)
    forbidden_keys = every_row_is_dict and any(_ECONOMIC_ACCOUNTING_ROWS_V0_FORBIDDEN_NAMES & set(row) for row in rows)
    forbidden_values = every_row_is_dict and any(
        isinstance(value, str) and value in _ECONOMIC_ACCOUNTING_ROWS_V0_FORBIDDEN_NAMES
        for row in rows for value in row.values()
    )
    amounts_neutral = every_row_is_dict and all(
        type(row.get("accounting_amount_value")) is int and row.get("accounting_amount_value") == 0
        for row in rows
    )
    def sort_key(row: dict[str, Any]) -> tuple[str, str, str, str, int]:
        sequence = row.get("accounting_sequence_id")
        return (str(row.get("symbol", "")), str(row.get("split_id", "")), str(row.get("split_partition", "")), str(row.get("accounting_time_utc", "")), sequence if isinstance(sequence, int) else -1)
    in_order = every_row_is_dict and rows == sorted(rows, key=sort_key)
    identities = [(row.get("run_id"), row.get("symbol"), row.get("split_id"), row.get("split_partition"), row.get("accounting_sequence_id")) for row in rows] if every_row_is_dict else []
    upstream_fields = tuple(key for key in diagnostics if key.endswith("_gate_passed"))
    output_offenders = [field for field in _ECONOMIC_ACCOUNTING_ROWS_V0_DOWNSTREAM_OUTPUT_FIELDS if diagnostics.get(field) is True]
    authorization_offenders = [field for field in _ECONOMIC_ACCOUNTING_ROWS_V0_DOWNSTREAM_AUTHORIZATION_FIELDS if diagnostics.get(field) is True]
    evidence = {**{field: diagnostics.get(field) for field in upstream_fields},
        "declared": diagnostics.get("economic_accounting_rows_v0_declared") is True,
        "mode_matches": diagnostics.get("economic_accounting_rows_v0_mode") == "SCHEMA_LOCKED_NEUTRAL_ACCOUNTING_ROW_ARTIFACT_ONLY",
        ...
        "schema_exact": schema_exact, "no_forbidden_keys": not forbidden_keys, "no_forbidden_values": not forbidden_values,
        "amounts_neutral": amounts_neutral and diagnostics.get("accounting_amount_values_all_neutral_zero") is True and diagnostics.get("accounting_non_neutral_amount_values_emitted") is False,
        "rows_in_order": in_order, "no_duplicate_identities": len(identities) == len(set(identities)),
        "cap_not_exceeded": diagnostics.get("simulated_event_cap_exceeded") is False,
        **{field: diagnostics.get(field) is True for field in ("rule_materialization_authorized", "simulated_event_generation_authorized", "economic_output_generation_authorized", "accounting_application_authorized", "amount_generation_authorized", "economic_value_generation_authorized")},
        "final_offline_verdict_remains": diagnostics.get("final_offline_verdict_remains")}
    def gate(status: str, reason: str | None) -> dict[str, Any]:
        return {"gate_kind": "economic_accounting_rows_v0_gate", "gate_scope": ECONOMIC_ACCOUNTING_ROWS_V0_SCOPE, "gate_status": status, "gate_passed": False, "gate_scoring_authorization": False, "gate_live_authorization": False, "gate_final_verdict_authorization": False, "gate_downstream_unlocks": [], "evidence": evidence, "blocked_reason": reason}
    if not diagnostics.get("economic_output_schema_lock_gate_passed"):
        return gate(BLOCKED_BY_ECONOMIC_OUTPUT_SCHEMA_LOCK_GATE, "ECONOMIC_OUTPUT_SCHEMA_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not diagnostics.get("simulated_events_v0_gate_passed"):
        return gate(BLOCKED_BY_SIMULATED_EVENTS_V0_GATE, "SIMULATED_EVENTS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not diagnostics.get("simulated_event_schema_lock_gate_passed"):
        return gate(BLOCKED_BY_SIMULATED_EVENT_SCHEMA_LOCK_GATE, "SIMULATED_EVENT_SCHEMA_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not diagnostics.get("materialized_rule_rows_v0_gate_passed"):
        return gate(BLOCKED_BY_MATERIALIZED_RULE_ROWS_V0_GATE, "MATERIALIZED_RULE_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if output_offenders:
        return gate(BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_DOWNSTREAM_OUTPUT, "UNEXPECTED_DOWNSTREAM_OUTPUT_FIELDS_TRUE")
    if authorization_offenders:
        return gate(BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_DOWNSTREAM_AUTHORIZATION, "UNEXPECTED_DOWNSTREAM_AUTHORIZATION_FIELDS_TRUE")
    if forbidden_keys:
        return gate(BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_FORBIDDEN_KEY, "FORBIDDEN_KEY_NAME_PRESENT_ON_ACCOUNTING_ROW")
    if forbidden_values:
        return gate(BLOCKED_BY_UNEXPECTED_ECONOMIC_ACCOUNTING_FORBIDDEN_VALUE, "FORBIDDEN_VALUE_PRESENT_ON_ACCOUNTING_ROW")
...
def _build_statistical_value_readiness_rows_v0_diagnostics(
    *, statistical_value_contract_lock_y0_diagnostics: dict[str, Any],
    ...
    """Project X1 metadata rows into Y1 readiness evidence without values."""
    def passed(section: dict[str, Any], gate_name: str) -> bool:
        gate = section.get(gate_name)
        return bool(isinstance(gate, dict) and gate.get("gate_passed") is True)

    source_rows = statistical_metadata_rows_v0_diagnostics.get("statistical_rows")
    source_rows = source_rows if isinstance(source_rows, list) else []
    cap_exceeded = len(source_rows) > STATISTICAL_VALUE_READINESS_ROWS_V0_MAX_ROWS
    upstream_fields = _STATISTICAL_VALUE_READINESS_Y1_UPSTREAM_GATE_FIELDS
    upstream = {field: economic_accounting_rows_v0_diagnostics.get(field) is True for field in upstream_fields}
    rows: list[dict[str, Any]] = []
    if (
        passed(statistical_value_contract_lock_y0_diagnostics, "statistical_value_contract_lock_gate")
        and passed(statistical_metadata_rows_v0_diagnostics, "statistical_metadata_rows_v0_gate")
        and passed(statistical_output_schema_lock_diagnostics, "statistical_output_schema_lock_gate")
        and passed(null_reference_comparison_rows_v0_diagnostics, "null_reference_comparison_rows_v0_gate")
        and passed(null_reference_comparison_schema_lock_diagnostics, "null_reference_comparison_schema_lock_gate")
        and passed(economic_accounting_rows_v0_diagnostics, "economic_accounting_rows_v0_gate")
        and all(upstream.values()) and not cap_exceeded
    ):
        for sequence, statistical_row in enumerate(source_rows, start=1):
            if not isinstance(statistical_row, dict):
                rows = []
                break
            rows.append({
                **_STATISTICAL_VALUE_READINESS_ROWS_V0_FIXED_ROW_CONSTANTS,
                "run_id": statistical_row.get("run_id"), "readiness_sequence_id": sequence,
                "source_statistical_sequence_id": statistical_row.get("statistical_sequence_id"),
                "source_comparison_sequence_id": statistical_row.get("source_comparison_sequence_id"),
                "source_accounting_sequence_id": statistical_row.get("source_accounting_sequence_id"),
                "source_event_sequence_id": statistical_row.get("source_event_sequence_id"),
                "source_rule_row_sequence_id": statistical_row.get("source_rule_row_sequence_id"),
                "symbol": statistical_row.get("symbol"), "split_id": statistical_row.get("split_id"),
                "split_partition": statistical_row.get("split_partition"),
                "readiness_time_utc": statistical_row.get("statistical_time_utc"),
                "source_statistical_time_utc": statistical_row.get("statistical_time_utc"),
                "source_comparison_time_utc": statistical_row.get("source_comparison_time_utc"),
                "source_accounting_time_utc": statistical_row.get("source_accounting_time_utc"),
                "source_event_time_utc": statistical_row.get("source_event_time_utc"),
                "readiness_value_present": False, "readiness_value": None,
                "readiness_metadata_only": True,
            })
        rows.sort(key=lambda row: (str(row["symbol"]), str(row["split_id"]), str(row["split_partition"]), str(row["readiness_time_utc"]), row["readiness_sequence_id"]))
    diagnostics: dict[str, Any] = {
        "diagnostic_kind": "statistical_value_readiness_rows_v0",
        "statistical_value_readiness_rows_v0_version": STATISTICAL_VALUE_READINESS_ROWS_V0_VERSION,
        "statistical_value_readiness_rows_v0_scope": STATISTICAL_VALUE_READINESS_ROWS_V0_SCOPE,
        "statistical_value_readiness_rows_v0_status": STATISTICAL_VALUE_READINESS_ROWS_V0_DECLARED_ARTIFACT_ONLY,
        "statistical_value_readiness_rows_v0_declared": True,
        ...
        "economic_accounting_rows_v0_gate_passed": passed(economic_accounting_rows_v0_diagnostics, "economic_accounting_rows_v0_gate"),
        **{field.replace("_passed", "_required"): True for field in upstream_fields}, **upstream,
        "readiness_rows": rows, "readiness_rows_emitted": bool(rows),
        "readiness_row_count": len(rows), "source_statistical_row_count": len(source_rows),
        "readiness_row_count_matches_source_statistical_row_count": len(rows) == len(source_rows),
        "readiness_rows_cap_exceeded": cap_exceeded,
        "readiness_schema_keys": list(_ALLOWED_STATISTICAL_VALUE_READINESS_ROW_KEYS),
        "readiness_schema_key_count": len(_ALLOWED_STATISTICAL_VALUE_READINESS_ROW_KEYS),
        "statistical_values": [], "statistical_values_emitted": False, "statistical_value_count": 0,
        **{field: False for field in _STATISTICAL_VALUE_READINESS_Y1_OUTPUT_FIELDS if field != "statistical_values_emitted"},
        **{field: False for field in _STATISTICAL_VALUE_READINESS_Y1_AUTHORIZATION_FIELDS},
        "downstream_unlocks": [],
        "final_offline_verdict_remains": BLOCKED_BY_VALIDATION_IMPLEMENTATION,
    }
    diagnostics["statistical_value_readiness_rows_v0_gate"] = _derive_statistical_value_readiness_rows_v0_gate(diagnostics)
    return diagnostics


def _derive_statistical_value_readiness_rows_v0_gate(diagnostics: dict[str, Any]) -> dict[str, Any]:
    """Fail closed unless Y1's deterministic metadata-only rows are exact."""
    rows = diagnostics.get("readiness_rows")
    rows_are_list = isinstance(rows, list)
    every_row_is_dict = rows_are_list and all(isinstance(row, dict) for row in rows)
    schema_exact = every_row_is_dict and all(set(row) == set(_ALLOWED_STATISTICAL_VALUE_READINESS_ROW_KEYS) for row in rows)
    constants_match = every_row_is_dict and all(all(row.get(field) == expected for field, expected in _STATISTICAL_VALUE_READINESS_ROWS_V0_FIXED_ROW_CONSTANTS.items()) for row in rows)
    values_absent = every_row_is_dict and all(row.get("readiness_value") is None for row in rows)
    values_not_present = every_row_is_dict and all(row.get("readiness_value_present") is False for row in rows)
    rows_metadata_only = every_row_is_dict and all(row.get("readiness_metadata_only") is True for row in rows)
    def sort_key(row: dict[str, Any]) -> tuple[str, str, str, str, int]:
        sequence = row.get("readiness_sequence_id")
        return (str(row.get("symbol", "")), str(row.get("split_id", "")), str(row.get("split_partition", "")), str(row.get("readiness_time_utc", "")), sequence if isinstance(sequence, int) else -1)
    identities = [(row.get("run_id"), row.get("symbol"), row.get("split_id"), row.get("split_partition"), row.get("readiness_sequence_id")) for row in rows] if every_row_is_dict else []
    upstream_fields = _STATISTICAL_VALUE_READINESS_Y1_UPSTREAM_GATE_FIELDS
    output_fields = _STATISTICAL_VALUE_READINESS_Y1_OUTPUT_FIELDS
    authorization_fields = _STATISTICAL_VALUE_READINESS_Y1_AUTHORIZATION_FIELDS
    ...
    evidence = {
        ...
        "accounting_rows_gate_passed": diagnostics.get("economic_accounting_rows_v0_gate_passed") is True,
        **{field: diagnostics.get(field) is True for field in upstream_fields},
        "declared": diagnostics.get("statistical_value_readiness_rows_v0_declared") is True,
        "status_matches": diagnostics.get("statistical_value_readiness_rows_v0_status") == STATISTICAL_VALUE_READINESS_ROWS_V0_DECLARED_ARTIFACT_ONLY,
        "rows_are_list": rows_are_list, "rows_emitted": diagnostics.get("readiness_rows_emitted") is True,
        "count_positive": rows_are_list and len(rows) > 0,
        "count_matches": rows_are_list and diagnostics.get("readiness_row_count") == len(rows) == diagnostics.get("source_statistical_row_count") and diagnostics.get("readiness_row_count_matches_source_statistical_row_count") is True,
        "schema_exact": schema_exact, "row_constants_match": constants_match,
        "values_absent": values_absent, "values_not_present": values_not_present, "rows_metadata_only": rows_metadata_only,
        "values_not_emitted": diagnostics.get("statistical_values") == [] and diagnostics.get("statistical_values_emitted") is False and diagnostics.get("statistical_value_count") == 0,
        "identities_unique": len(identities) == len(set(identities)), "rows_in_order": every_row_is_dict and rows == sorted(rows, key=sort_key),
        "cap_not_exceeded": diagnostics.get("readiness_rows_cap_exceeded") is False,
        **{f"{field}_is_exactly_false": diagnostics.get(field) is False for field in exact_false_fields},
        "downstream_unlocks_empty": diagnostics.get("downstream_unlocks") == [],
    }
    def gate(status: str, reason: str | None) -> dict[str, Any]:
        return {"gate_kind": "statistical_value_readiness_rows_v0_gate", "gate_scope": STATISTICAL_VALUE_READINESS_ROWS_V0_SCOPE, "gate_status": status, "gate_passed": False, "gate_scoring_authorization": False, "gate_live_authorization": False, "gate_final_verdict_authorization": False, "gate_downstream_unlocks": [], "evidence": evidence, "blocked_reason": reason}
    if not evidence["contract_lock_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_VALUE_CONTRACT_LOCK_Y0_FOR_Y1_GATE, "STATISTICAL_VALUE_CONTRACT_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["metadata_rows_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_METADATA_ROWS_V0_FOR_Y1_GATE, "STATISTICAL_METADATA_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["schema_lock_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_OUTPUT_SCHEMA_LOCK_X0_FOR_Y1_GATE, "STATISTICAL_OUTPUT_SCHEMA_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["comparison_rows_gate_passed"]: return gate(BLOCKED_BY_NULL_REFERENCE_COMPARISON_ROWS_V0_FOR_Y1_GATE, "NULL_REFERENCE_COMPARISON_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["comparison_schema_gate_passed"]: return gate(BLOCKED_BY_NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_FOR_Y1_GATE, "NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["accounting_rows_gate_passed"]: return gate(BLOCKED_BY_ECONOMIC_ACCOUNTING_ROWS_V0_FOR_Y1_GATE, "ECONOMIC_ACCOUNTING_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not all(evidence[field] is True for field in upstream_fields): return gate(BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_UPSTREAM_GATE, "REQUIRED_UPSTREAM_GATE_MISSING_OR_NOT_PASSED")
    if evidence["cap_not_exceeded"] is False: return gate(BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROW_CAP_EXCEEDED, "READINESS_ROW_CAP_EXCEEDED")
    if every_row_is_dict and not schema_exact: return gate(BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_ROW_SCHEMA, "ROW_KEYS_DO_NOT_EXACTLY_MATCH_Y1_ALLOWED_SCHEMA_KEYS")
    if every_row_is_dict and not constants_match: return gate(BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_ROW_CONSTANTS, "ROW_CONSTANTS_DO_NOT_MATCH_Y1_SCHEMA_LOCKED_METADATA_PROJECTION")
    if every_row_is_dict and not values_absent: return gate(BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUE_READINESS_VALUE, "READINESS_VALUE_MUST_BE_NONE")
    if every_row_is_dict and not values_not_present: return gate(BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUE_READINESS_VALUE, "READINESS_VALUE_PRESENT_MUST_BE_FALSE")
    if diagnostics.get("statistical_values") != [] or diagnostics.get("statistical_values_emitted") is True or diagnostics.get("statistical_value_count") != 0: return gate(BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_Y1, "STATISTICAL_VALUES_MUST_NOT_BE_EMITTED")
    if any(diagnostics.get(field) is True for field in ("inferential_values_emitted", "uncertainty_values_emitted", "candidate_comparison_values_emitted")): return gate(BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_INFERENTIAL_OUTPUT, "UNEXPECTED_INFERENTIAL_UNCERTAINTY_OR_CANDIDATE_OUTPUT")
    if any(diagnostics.get(field) is True for field in ("scoring_values_emitted", "live_integration_values_emitted", "paper_integration_values_emitted", "final_verdict_values_emitted")): return gate(BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_DOWNSTREAM_OUTPUT, "UNEXPECTED_DOWNSTREAM_OUTPUT")
    if any(diagnostics.get(field) is True for field in authorization_fields): return gate(BLOCKED_BY_UNEXPECTED_STATISTICAL_VALUE_READINESS_DOWNSTREAM_AUTHORIZATION, "UNEXPECTED_DOWNSTREAM_AUTHORIZATION")
    if diagnostics.get("final_offline_verdict_remains") != BLOCKED_BY_VALIDATION_IMPLEMENTATION: return gate(BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_FINAL_VERDICT_ADVANCEMENT, "FINAL_OFFLINE_VERDICT_MUST_REMAIN_BLOCKED")
    if every_row_is_dict and not evidence["identities_unique"]: return gate(BLOCKED_BY_DUPLICATE_STATISTICAL_VALUE_READINESS_ROW_IDENTITY, "DUPLICATE_READINESS_ROW_IDENTITY")
    if every_row_is_dict and not evidence["rows_in_order"]: return gate(BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROW_ORDERING_MUTATION, "READINESS_ROWS_NOT_DETERMINISTICALLY_ORDERED")
    if rows_are_list and not evidence["count_matches"]: return gate(BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROW_SOURCE_COUNT_MISMATCH, "READINESS_ROW_COUNT_DOES_NOT_MATCH_SOURCE_STATISTICAL_ROW_COUNT")
    required = ("declared", "status_matches", "rows_are_list", "rows_emitted", "count_positive", "count_matches", "schema_exact", "row_constants_match", "values_absent", "values_not_present", "rows_metadata_only", "values_not_emitted", "identities_unique", "rows_in_order", "cap_not_exceeded", "downstream_unlocks_empty") + tuple(f"{field}_is_exactly_false" for field in exact_false_fields)
    if not all(evidence.get(field) is True for field in required): return gate(BLOCKED_BY_INCOMPLETE_STATISTICAL_VALUE_READINESS_ROWS_V0_EVIDENCE, "STATISTICAL_VALUE_READINESS_ROWS_V0_EVIDENCE_INCOMPLETE_OR_MUTATED")
    result = gate(STATISTICAL_VALUE_READINESS_ROWS_V0_DECLARED_ARTIFACT_ONLY, None)
    result["gate_passed"] = True
    return result
...
def _build_descriptive_statistical_metadata_rows_v0_diagnostics(
    *, descriptive_statistical_value_schema_lock_z0_diagnostics: dict[str, Any],
    ...
    """Project Y1 readiness metadata into Z1 descriptive rows without values."""
    def passed(section: dict[str, Any], gate_name: str) -> bool:
        gate = section.get(gate_name)
        return bool(isinstance(gate, dict) and gate.get("gate_passed") is True)

    source_rows = statistical_value_readiness_rows_v0_diagnostics.get("readiness_rows")
    source_rows = source_rows if isinstance(source_rows, list) else []
    cap_exceeded = len(source_rows) > DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_MAX_ROWS
    upstream_fields = _DESCRIPTIVE_STATISTICAL_METADATA_ROWS_Z1_UPSTREAM_GATE_FIELDS
    upstream = {field: economic_accounting_rows_v0_diagnostics.get(field) is True for field in upstream_fields}
    gates_passed = (
        passed(descriptive_statistical_value_schema_lock_z0_diagnostics, "descriptive_statistical_value_schema_lock_z0_gate")
        and passed(statistical_value_readiness_rows_v0_diagnostics, "statistical_value_readiness_rows_v0_gate")
        and passed(statistical_value_contract_lock_y0_diagnostics, "statistical_value_contract_lock_gate")
        and passed(statistical_metadata_rows_v0_diagnostics, "statistical_metadata_rows_v0_gate")
        and passed(statistical_output_schema_lock_diagnostics, "statistical_output_schema_lock_gate")
        and passed(null_reference_comparison_rows_v0_diagnostics, "null_reference_comparison_rows_v0_gate")
        and passed(null_reference_comparison_schema_lock_diagnostics, "null_reference_comparison_schema_lock_gate")
    ...
    rows: list[dict[str, Any]] = []
    if gates_passed:
        for sequence, readiness_row in enumerate(source_rows, start=1):
            if not isinstance(readiness_row, dict):
                rows = []
                break
            rows.append({
                **_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FIXED_ROW_CONSTANTS,
                "run_id": readiness_row.get("run_id"), "descriptive_sequence_id": sequence,
                "source_readiness_sequence_id": readiness_row.get("readiness_sequence_id"),
                "source_statistical_sequence_id": readiness_row.get("source_statistical_sequence_id"),
                "source_comparison_sequence_id": readiness_row.get("source_comparison_sequence_id"),
                "source_accounting_sequence_id": readiness_row.get("source_accounting_sequence_id"),
                "source_event_sequence_id": readiness_row.get("source_event_sequence_id"),
                "source_rule_row_sequence_id": readiness_row.get("source_rule_row_sequence_id"),
                "symbol": readiness_row.get("symbol"), "split_id": readiness_row.get("split_id"),
                "split_partition": readiness_row.get("split_partition"),
                "descriptive_time_utc": readiness_row.get("readiness_time_utc"),
                "source_readiness_time_utc": readiness_row.get("readiness_time_utc"),
                "source_statistical_time_utc": readiness_row.get("source_statistical_time_utc"),
                "source_comparison_time_utc": readiness_row.get("source_comparison_time_utc"),
                "source_accounting_time_utc": readiness_row.get("source_accounting_time_utc"),
                "source_event_time_utc": readiness_row.get("source_event_time_utc"),
                "descriptive_value_present": False, "descriptive_value": None,
                "descriptive_metadata_only": True,
            })
        rows.sort(key=lambda row: (str(row["symbol"]), str(row["split_id"]), str(row["split_partition"]), str(row["descriptive_time_utc"]), row["descriptive_sequence_id"]))
    diagnostics: dict[str, Any] = {
        "diagnostic_kind": "descriptive_statistical_metadata_rows_v0",
        "descriptive_statistical_metadata_rows_v0_version": DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_VERSION,
        "descriptive_statistical_metadata_rows_v0_scope": DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_SCOPE,
        "descriptive_statistical_metadata_rows_v0_status": DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_DECLARED_ARTIFACT_ONLY,
        "descriptive_statistical_metadata_rows_v0_declared": True,
        ...
        "economic_accounting_rows_v0_gate_passed": passed(economic_accounting_rows_v0_diagnostics, "economic_accounting_rows_v0_gate"),
        **{field.replace("_passed", "_required"): True for field in upstream_fields}, **upstream,
        "descriptive_value_rows": rows, "descriptive_value_rows_emitted": bool(rows),
        "descriptive_value_row_count": len(rows), "source_readiness_row_count": len(source_rows),
        "descriptive_value_row_count_matches_source_readiness_row_count": len(rows) == len(source_rows),
        "descriptive_value_rows_cap_exceeded": cap_exceeded,
        "descriptive_schema_keys": list(_ALLOWED_DESCRIPTIVE_STATISTICAL_VALUE_ROW_KEYS),
        "descriptive_schema_key_count": len(_ALLOWED_DESCRIPTIVE_STATISTICAL_VALUE_ROW_KEYS),
        "descriptive_values_emitted": False, "descriptive_value_count": 0,
        "statistical_values": [], "statistical_values_emitted": False, "statistical_value_count": 0,
        **{field: False for field in _DESCRIPTIVE_STATISTICAL_METADATA_ROWS_Z1_OUTPUT_FIELDS if field != "statistical_values_emitted"},
        **{field: False for field in _DESCRIPTIVE_STATISTICAL_METADATA_ROWS_Z1_AUTHORIZATION_FIELDS},
        "downstream_unlocks": [], "final_offline_verdict_remains": BLOCKED_BY_VALIDATION_IMPLEMENTATION,
    }
    diagnostics["descriptive_statistical_metadata_rows_v0_gate"] = _derive_descriptive_statistical_metadata_rows_v0_gate(diagnostics)
    return diagnostics


def _derive_descriptive_statistical_metadata_rows_v0_gate(diagnostics: dict[str, Any]) -> dict[str, Any]:
    """Fail closed unless Z1 metadata rows exactly project Y1 readiness rows."""
    rows = diagnostics.get("descriptive_value_rows")
    rows_are_list = isinstance(rows, list)
    every_row_is_dict = rows_are_list and all(isinstance(row, dict) for row in rows)
    schema_exact = every_row_is_dict and all(set(row) == set(_ALLOWED_DESCRIPTIVE_STATISTICAL_VALUE_ROW_KEYS) for row in rows)
    constants_match = every_row_is_dict and all(all(row.get(field) == expected for field, expected in _DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FIXED_ROW_CONSTANTS.items()) for row in rows)
    values_absent = every_row_is_dict and all(row.get("descriptive_value") is None for row in rows)
    values_not_present = every_row_is_dict and all(row.get("descriptive_value_present") is False for row in rows)
    rows_metadata_only = every_row_is_dict and all(row.get("descriptive_metadata_only") is True for row in rows)
    def sort_key(row: dict[str, Any]) -> tuple[str, str, str, str, int]:
        sequence = row.get("descriptive_sequence_id")
        return (str(row.get("symbol", "")), str(row.get("split_id", "")), str(row.get("split_partition", "")), str(row.get("descriptive_time_utc", "")), sequence if isinstance(sequence, int) else -1)
    ...
    upstream_fields = _DESCRIPTIVE_STATISTICAL_METADATA_ROWS_Z1_UPSTREAM_GATE_FIELDS
    output_fields = _DESCRIPTIVE_STATISTICAL_METADATA_ROWS_Z1_OUTPUT_FIELDS
    authorization_fields = _DESCRIPTIVE_STATISTICAL_METADATA_ROWS_Z1_AUTHORIZATION_FIELDS
    exact_false_fields = output_fields + authorization_fields
    evidence = {
        "z0_gate_passed": diagnostics.get("descriptive_statistical_value_schema_lock_z0_gate_passed") is True,
        "readiness_rows_gate_passed": diagnostics.get("statistical_value_readiness_rows_v0_gate_passed") is True,
        "contract_lock_gate_passed": diagnostics.get("statistical_value_contract_lock_gate_passed") is True,
        "metadata_rows_gate_passed": diagnostics.get("statistical_metadata_rows_v0_gate_passed") is True,
        "schema_lock_gate_passed": diagnostics.get("statistical_output_schema_lock_gate_passed") is True,
        ...
        "accounting_rows_gate_passed": diagnostics.get("economic_accounting_rows_v0_gate_passed") is True,
        **{field: diagnostics.get(field) is True for field in upstream_fields},
        "declared": diagnostics.get("descriptive_statistical_metadata_rows_v0_declared") is True,
        "status_matches": diagnostics.get("descriptive_statistical_metadata_rows_v0_status") == DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_DECLARED_ARTIFACT_ONLY,
        "rows_are_list": rows_are_list, "rows_emitted": diagnostics.get("descriptive_value_rows_emitted") is True,
        "count_positive": rows_are_list and len(rows) > 0,
        "count_matches": rows_are_list and diagnostics.get("descriptive_value_row_count") == len(rows) == diagnostics.get("source_readiness_row_count") and diagnostics.get("descriptive_value_row_count_matches_source_readiness_row_count") is True,
        "schema_exact": schema_exact, "row_constants_match": constants_match,
        "values_absent": values_absent, "values_not_present": values_not_present, "rows_metadata_only": rows_metadata_only,
        "values_not_emitted": diagnostics.get("descriptive_values_emitted") is False and diagnostics.get("descriptive_value_count") == 0,
        ...
        "identities_unique": len(identities) == len(set(identities)), "rows_in_order": every_row_is_dict and rows == sorted(rows, key=sort_key),
        "cap_not_exceeded": diagnostics.get("descriptive_value_rows_cap_exceeded") is False,
        **{f"{field}_is_exactly_false": diagnostics.get(field) is False for field in exact_false_fields},
        "downstream_unlocks_empty": diagnostics.get("downstream_unlocks") == [],
    }
    def gate(status: str, reason: str | None) -> dict[str, Any]:
        return {"gate_kind": "descriptive_statistical_metadata_rows_v0_gate", "gate_scope": DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_SCOPE, "gate_status": status, "gate_passed": False, "gate_scoring_authorization": False, "gate_live_authorization": False, "gate_final_verdict_authorization": False, "gate_downstream_unlocks": [], "evidence": evidence, "blocked_reason": reason}
    if not evidence["z0_gate_passed"]: return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_FOR_Z1_GATE, "DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["readiness_rows_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_FOR_Z1_GATE, "STATISTICAL_VALUE_READINESS_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["contract_lock_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_VALUE_CONTRACT_LOCK_Y0_FOR_Z1_GATE, "STATISTICAL_VALUE_CONTRACT_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["metadata_rows_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_METADATA_ROWS_V0_FOR_Z1_GATE, "STATISTICAL_METADATA_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["schema_lock_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_OUTPUT_SCHEMA_LOCK_X0_FOR_Z1_GATE, "STATISTICAL_OUTPUT_SCHEMA_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["comparison_rows_gate_passed"]: return gate(BLOCKED_BY_NULL_REFERENCE_COMPARISON_ROWS_V0_FOR_Z1_GATE, "NULL_REFERENCE_COMPARISON_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["comparison_schema_gate_passed"]: return gate(BLOCKED_BY_NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_FOR_Z1_GATE, "NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["accounting_rows_gate_passed"]: return gate(BLOCKED_BY_ECONOMIC_ACCOUNTING_ROWS_V0_FOR_Z1_GATE, "ECONOMIC_ACCOUNTING_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not all(evidence[field] is True for field in upstream_fields): return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_UPSTREAM_GATE, "REQUIRED_UPSTREAM_GATE_MISSING_OR_NOT_PASSED")
    if evidence["cap_not_exceeded"] is False: return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROW_CAP_EXCEEDED, "DESCRIPTIVE_ROW_CAP_EXCEEDED")
    if every_row_is_dict and not schema_exact: return gate(BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_ROW_SCHEMA, "ROW_KEYS_DO_NOT_EXACTLY_MATCH_Z0_ALLOWED_SCHEMA_KEYS")
    if every_row_is_dict and not constants_match: return gate(BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_ROW_CONSTANTS, "ROW_CONSTANTS_DO_NOT_MATCH_Z1_SCHEMA_LOCKED_METADATA_PROJECTION")
    if every_row_is_dict and (not values_absent or not values_not_present): return gate(BLOCKED_BY_UNEXPECTED_EMITTED_DESCRIPTIVE_STATISTICAL_METADATA_VALUE, "DESCRIPTIVE_VALUE_MUST_BE_NONE_AND_NOT_PRESENT")
    if diagnostics.get("descriptive_values_emitted") is True or diagnostics.get("descriptive_value_count") != 0: return gate(BLOCKED_BY_UNEXPECTED_EMITTED_DESCRIPTIVE_STATISTICAL_METADATA_VALUE, "DESCRIPTIVE_VALUES_MUST_NOT_BE_EMITTED")
    if diagnostics.get("statistical_values") != [] or diagnostics.get("statistical_values_emitted") is True or diagnostics.get("statistical_value_count") != 0: return gate(BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_Z1, "STATISTICAL_VALUES_MUST_NOT_BE_EMITTED")
    if any(diagnostics.get(field) is True for field in ("inferential_values_emitted", "uncertainty_values_emitted", "candidate_comparison_values_emitted")): return gate(BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_INFERENTIAL_OUTPUT, "UNEXPECTED_INFERENTIAL_UNCERTAINTY_OR_CANDIDATE_OUTPUT")
    if any(diagnostics.get(field) is True for field in ("scoring_values_emitted", "live_integration_values_emitted", "paper_integration_values_emitted", "final_verdict_values_emitted")): return gate(BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_DOWNSTREAM_OUTPUT, "UNEXPECTED_DOWNSTREAM_OUTPUT")
    if any(diagnostics.get(field) is True for field in authorization_fields): return gate(BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_METADATA_DOWNSTREAM_AUTHORIZATION, "UNEXPECTED_DOWNSTREAM_AUTHORIZATION")
    if diagnostics.get("final_offline_verdict_remains") != BLOCKED_BY_VALIDATION_IMPLEMENTATION: return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FINAL_VERDICT_ADVANCEMENT, "FINAL_OFFLINE_VERDICT_MUST_REMAIN_BLOCKED")
    if every_row_is_dict and not evidence["identities_unique"]: return gate(BLOCKED_BY_DUPLICATE_DESCRIPTIVE_STATISTICAL_METADATA_ROW_IDENTITY, "DUPLICATE_DESCRIPTIVE_ROW_IDENTITY")
    if every_row_is_dict and not evidence["rows_in_order"]: return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROW_ORDERING_MUTATION, "DESCRIPTIVE_ROWS_NOT_DETERMINISTICALLY_ORDERED")
    if rows_are_list and not evidence["count_matches"]: return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROW_SOURCE_COUNT_MISMATCH, "DESCRIPTIVE_ROW_COUNT_DOES_NOT_MATCH_SOURCE_READINESS_ROW_COUNT")
    required = ("declared", "status_matches", "rows_are_list", "rows_emitted", "count_positive", "count_matches", "schema_exact", "row_constants_match", "values_absent", "values_not_present", "rows_metadata_only", "values_not_emitted", "statistical_values_not_emitted", "identities_unique", "rows_in_order", "cap_not_exceeded", "downstream_unlocks_empty") + tuple(f"{field}_is_exactly_false" for field in exact_false_fields)
    if not all(evidence.get(field) is True for field in required): return gate(BLOCKED_BY_INCOMPLETE_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_EVIDENCE, "DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_EVIDENCE_INCOMPLETE_OR_MUTATED")
    result = gate(DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_DECLARED_ARTIFACT_ONLY, None)
    result["gate_passed"] = True
    return result


def _build_descriptive_statistical_value_policy_lock_aa0_diagnostics(
    *, descriptive_statistical_metadata_rows_v0_diagnostics: dict[str, Any],
    ...
    """Declare AA0's future metadata-count policy without generating values."""
    def passed(section: dict[str, Any], gate_name: str) -> bool:
        gate = section.get(gate_name)
        return bool(isinstance(gate, dict) and gate.get("gate_passed") is True)
    ...
    diagnostics: dict[str, Any] = {
        ...
        "descriptive_statistical_value_policy_lock_version": DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_VERSION,
        "descriptive_statistical_value_policy_lock_scope": DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_SCOPE,
        "descriptive_statistical_value_policy_lock_status": DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_DECLARED_DIAGNOSTIC_ONLY,
        ...
        **{field.replace("_passed", "_required"): True for field in upstream_fields},
        **{field: economic_accounting_rows_v0_diagnostics.get(field) is True for field in upstream_fields},
        "descriptive_statistical_value_policy_lock_declared": True,
        "declared_descriptive_statistical_value_policy_keys": list(_ALLOWED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_KEYS_AA0),
        "declared_descriptive_statistical_value_policy_key_count": len(_ALLOWED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_KEYS_AA0),
        "declared_future_descriptive_value_kind_names": list(_ALLOWED_FUTURE_DESCRIPTIVE_VALUE_KIND_NAMES_AA0),
        "declared_future_descriptive_value_kind_count": len(_ALLOWED_FUTURE_DESCRIPTIVE_VALUE_KIND_NAMES_AA0),
        "source_descriptive_metadata_row_count": len(descriptive_statistical_metadata_rows_v0_diagnostics.get("descriptive_value_rows", [])),
        "descriptive_value_policy": policy,
        "descriptive_value_rows": [], "descriptive_value_rows_emitted": False,
        "descriptive_value_row_count": 0, "descriptive_values_emitted": False,
        "descriptive_value_count": 0, "statistical_values": [],
        "statistical_values_emitted": False, "statistical_value_count": 0,
        **{field: False for field in _DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_OUTPUT_FIELDS if field != "statistical_values_emitted"},
        **{field: False for field in _DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_AUTHORIZATION_FIELDS},
        "downstream_unlocks": [], "final_offline_verdict_remains": BLOCKED_BY_VALIDATION_IMPLEMENTATION,
    }
    diagnostics["descriptive_statistical_value_policy_lock_aa0_gate"] = _derive_descriptive_statistical_value_policy_lock_aa0_gate(diagnostics)
    return diagnostics


def _derive_descriptive_statistical_value_policy_lock_aa0_gate(diagnostics: dict[str, Any]) -> dict[str, Any]:
    """Fail closed unless AA0 declares its exact policy and emits nothing."""
    upstream_fields = _DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_UPSTREAM_GATE_FIELDS
    output_fields = _DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_OUTPUT_FIELDS
    authorization_fields = _DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_AUTHORIZATION_FIELDS
    exact_false_fields = output_fields + authorization_fields
    policy = diagnostics.get("descriptive_value_policy")
    evidence = {
        ...
        **{field: diagnostics.get(field) is True for field in upstream_fields},
        ...
        "value_count_zero": diagnostics.get("descriptive_value_count") == 0, "statistical_values_empty": diagnostics.get("statistical_values") == [],
        "statistical_values_not_emitted": diagnostics.get("statistical_values_emitted") is False, "statistical_value_count_zero": diagnostics.get("statistical_value_count") == 0,
        **{f"{field}_is_exactly_false": diagnostics.get(field) is False for field in exact_false_fields},
        "downstream_unlocks_empty": diagnostics.get("downstream_unlocks") == [],
    }
    def gate(status: str, reason: str | None) -> dict[str, Any]:
        return {"gate_kind": "descriptive_statistical_value_policy_lock_aa0_gate", "gate_scope": DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_SCOPE, "gate_status": status, "gate_passed": False, "gate_scoring_authorization": False, "gate_live_authorization": False, "gate_final_verdict_authorization": False, "gate_downstream_unlocks": [], "evidence": evidence, "blocked_reason": reason}
    if not evidence["z1_gate_passed"]: return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FOR_AA0_GATE, "DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["z0_gate_passed"]: return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_FOR_AA0_GATE, "DESCRIPTIVE_STATISTICAL_VALUE_SCHEMA_LOCK_Z0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["readiness_rows_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_VALUE_READINESS_ROWS_V0_FOR_AA0_GATE, "STATISTICAL_VALUE_READINESS_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["contract_lock_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_VALUE_CONTRACT_LOCK_Y0_FOR_AA0_GATE, "STATISTICAL_VALUE_CONTRACT_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["metadata_rows_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_METADATA_ROWS_V0_FOR_AA0_GATE, "STATISTICAL_METADATA_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["schema_lock_gate_passed"]: return gate(BLOCKED_BY_STATISTICAL_OUTPUT_SCHEMA_LOCK_X0_FOR_AA0_GATE, "STATISTICAL_OUTPUT_SCHEMA_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["comparison_rows_gate_passed"]: return gate(BLOCKED_BY_NULL_REFERENCE_COMPARISON_ROWS_V0_FOR_AA0_GATE, "NULL_REFERENCE_COMPARISON_ROWS_V0_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["comparison_schema_gate_passed"]: return gate(BLOCKED_BY_NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_FOR_AA0_GATE, "NULL_REFERENCE_COMPARISON_SCHEMA_LOCK_GATE_MISSING_OR_NOT_PASSED")
    ...
    if not (evidence["values_not_emitted"] and evidence["value_count_zero"]): return gate(BLOCKED_BY_UNEXPECTED_EMITTED_DESCRIPTIVE_STATISTICAL_VALUES_AA0, "DESCRIPTIVE_VALUES_MUST_NOT_BE_EMITTED_IN_AA0")
    if not (evidence["statistical_values_empty"] and evidence["statistical_values_not_emitted"] and evidence["statistical_value_count_zero"]): return gate(BLOCKED_BY_UNEXPECTED_EMITTED_STATISTICAL_VALUES_AA0, "STATISTICAL_VALUES_MUST_NOT_BE_EMITTED_IN_AA0")
    if any(diagnostics.get(field) is True for field in ("inferential_values_emitted", "uncertainty_values_emitted", "candidate_comparison_values_emitted")): return gate(BLOCKED_BY_UNEXPECTED_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_INFERENTIAL_OUTPUT, "UNEXPECTED_INFERENTIAL_UNCERTAINTY_OR_CANDIDATE_OUTPUT")
...
def _build_descriptive_count_values_v0_diagnostics(
    *, descriptive_statistical_value_policy_lock_aa0_diagnostics: dict[str, Any],
    ...
    """Emit AA0-authorized counts from already-materialized Z1 metadata rows."""
    def passed(section: dict[str, Any], gate_name: str) -> bool:
        gate = section.get(gate_name)
        return bool(isinstance(gate, dict) and gate.get("gate_passed") is True)

    source_rows = descriptive_statistical_metadata_rows_v0_diagnostics.get("descriptive_value_rows")
    source_rows = source_rows if isinstance(source_rows, list) else []
    upstream_fields = _DESCRIPTIVE_COUNT_VALUES_V0_UPSTREAM_GATE_FIELDS
    upstream = {field: economic_accounting_rows_v0_diagnostics.get(field) is True for field in upstream_fields}
    aa0_policy_literal_accepted = (
        passed(descriptive_statistical_value_policy_lock_aa0_diagnostics, "descriptive_statistical_value_policy_lock_aa0_gate")
        and descriptive_statistical_value_policy_lock_aa0_diagnostics.get("descriptive_value_policy") == _DESCRIPTIVE_STATISTICAL_VALUE_POLICY_AA0_EXPECTED
    )
    gates_passed = (
        aa0_policy_literal_accepted
        and passed(descriptive_statistical_metadata_rows_v0_diagnostics, "descriptive_statistical_metadata_rows_v0_gate")
        and passed(descriptive_statistical_value_schema_lock_z0_diagnostics, "descriptive_statistical_value_schema_lock_z0_gate")
        and passed(statistical_value_readiness_rows_v0_diagnostics, "statistical_value_readiness_rows_v0_gate")
        and passed(statistical_value_contract_lock_y0_diagnostics, "statistical_value_contract_lock_gate")
        and passed(statistical_metadata_rows_v0_diagnostics, "statistical_metadata_rows_v0_gate")
        and passed(statistical_output_schema_lock_diagnostics, "statistical_output_schema_lock_gate")
    ...
    rows: list[dict[str, Any]] = []
    if gates_passed and all(isinstance(row, dict) for row in source_rows):
        run_id = source_rows[0].get("run_id") if source_rows else None
        descriptive_time_utc = max((row.get("descriptive_time_utc") for row in source_rows), default=None)
        count_values = (
        ...
        for sequence, (value_kind, value) in enumerate(count_values, start=1):
            rows.append({
                **_DESCRIPTIVE_COUNT_VALUES_V0_FIXED_ROW_CONSTANTS,
                "run_id": run_id, "descriptive_sequence_id": sequence,
                "source_readiness_sequence_id": None, "source_statistical_sequence_id": None,
                "source_comparison_sequence_id": None, "source_accounting_sequence_id": None,
                "source_event_sequence_id": None, "source_rule_row_sequence_id": None,
                "symbol": "__ALL_SYMBOLS__", "split_id": "__ALL_SPLITS__",
                "split_partition": "__ALL_PARTITIONS__", "descriptive_time_utc": descriptive_time_utc,
                "source_readiness_time_utc": None, "source_statistical_time_utc": None,
                "source_comparison_time_utc": None, "source_accounting_time_utc": None,
                "source_event_time_utc": None, "descriptive_value_kind": value_kind,
                "descriptive_value_present": True, "descriptive_value": value,
                "descriptive_metadata_only": False,
            })
    diagnostics: dict[str, Any] = {
        "diagnostic_kind": "descriptive_count_values_v0",
        "descriptive_count_values_v0_version": DESCRIPTIVE_COUNT_VALUES_V0_VERSION,
        "descriptive_count_values_v0_scope": DESCRIPTIVE_COUNT_VALUES_V0_SCOPE,
        "descriptive_count_values_v0_status": DESCRIPTIVE_COUNT_VALUES_V0_DECLARED_ARTIFACT,
        "descriptive_count_values_v0_declared": True,
        ...
        "economic_accounting_rows_v0_gate_passed": passed(economic_accounting_rows_v0_diagnostics, "economic_accounting_rows_v0_gate"),
        **{field.replace("_passed", "_required"): True for field in upstream_fields}, **upstream,
        "aa0_policy_literal_accepted": aa0_policy_literal_accepted,
        "allowed_descriptive_value_kind_names": list(_ALLOWED_DESCRIPTIVE_COUNT_VALUE_KIND_NAMES_AA1),
        "source_descriptive_metadata_rows": source_rows,
        "source_descriptive_metadata_row_count": len(source_rows),
        "descriptive_value_rows": rows, "descriptive_value_rows_emitted": bool(rows),
        "descriptive_value_row_count": len(rows), "descriptive_values_emitted": bool(rows),
        "descriptive_value_count": len(rows), "statistical_values": [],
        "statistical_values_emitted": False, "statistical_value_count": 0,
        **{field: False for field in _DESCRIPTIVE_COUNT_VALUES_V0_OUTPUT_FIELDS if field != "statistical_values_emitted"},
        **{field: False for field in _DESCRIPTIVE_COUNT_VALUES_V0_AUTHORIZATION_FIELDS},
        "downstream_unlocks": [], "final_offline_verdict_remains": BLOCKED_BY_VALIDATION_IMPLEMENTATION,
    }
    diagnostics["descriptive_count_values_v0_gate"] = _derive_descriptive_count_values_v0_gate(diagnostics)
    return diagnostics


def _derive_descriptive_count_values_v0_gate(diagnostics: dict[str, Any]) -> dict[str, Any]:
    """Fail closed unless AA1 has only the exact AA0-approved metadata counts."""
    rows = diagnostics.get("descriptive_value_rows")
    rows_are_list = isinstance(rows, list)
    every_row_is_dict = rows_are_list and all(isinstance(row, dict) for row in rows)
    upstream_fields = _DESCRIPTIVE_COUNT_VALUES_V0_UPSTREAM_GATE_FIELDS
    output_fields = _DESCRIPTIVE_COUNT_VALUES_V0_OUTPUT_FIELDS
    authorization_fields = _DESCRIPTIVE_COUNT_VALUES_V0_AUTHORIZATION_FIELDS
    exact_false_fields = output_fields + authorization_fields
    ...
    evidence = {
        ...
        "accounting_rows_gate_passed": diagnostics.get("economic_accounting_rows_v0_gate_passed") is True,
        **{field: diagnostics.get(field) is True for field in upstream_fields},
        "declared": diagnostics.get("descriptive_count_values_v0_declared") is True,
        "status_matches": diagnostics.get("descriptive_count_values_v0_status") == DESCRIPTIVE_COUNT_VALUES_V0_DECLARED_ARTIFACT,
        "aa0_policy_literal_accepted": diagnostics.get("aa0_policy_literal_accepted") is True,
        "allowed_kind_names_match": diagnostics.get("allowed_descriptive_value_kind_names") == list(_ALLOWED_DESCRIPTIVE_COUNT_VALUE_KIND_NAMES_AA1),
        "rows_are_list": rows_are_list, "rows_emitted": diagnostics.get("descriptive_value_rows_emitted") is True,
        "row_count_matches": diagnostics.get("descriptive_value_row_count") == 3 and rows_are_list and len(rows) == 3,
    ...
    def gate(status: str, reason: str | None) -> dict[str, Any]:
        return {"gate_kind": "descriptive_count_values_v0_gate", "gate_scope": DESCRIPTIVE_COUNT_VALUES_V0_SCOPE, "gate_status": status, "gate_passed": False, "gate_scoring_authorization": False, "gate_live_authorization": False, "gate_final_verdict_authorization": False, "gate_downstream_unlocks": [], "evidence": evidence, "blocked_reason": reason}
    if not evidence["aa0_gate_passed"]: return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_VALUE_POLICY_LOCK_AA0_FOR_AA1_GATE, "AA0_POLICY_LOCK_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["z1_gate_passed"]: return gate(BLOCKED_BY_DESCRIPTIVE_STATISTICAL_METADATA_ROWS_V0_FOR_AA1_GATE, "Z1_METADATA_ROWS_GATE_MISSING_OR_NOT_PASSED")
    if not all(evidence[field] is True for field in ("z0_gate_passed", "readiness_rows_gate_passed", "contract_lock_gate_passed", "metadata_rows_gate_passed", "schema_lock_gate_passed", "comparison_rows_gate_passed", "comparison_schema_gate_passed", "accounting_rows_gate_passed")): return gate(BLOCKED_BY_DESCRIPTIVE_COUNT_VALUES_V0_UPSTREAM_GATE, "REQUIRED_Z0_TO_V1_GATE_MISSING_OR_NOT_PASSED")
    if not all(evidence[field] is True for field in upstream_fields): return gate(BLOCKED_BY_DESCRIPTIVE_COUNT_VALUES_V0_UPSTREAM_GATE, "REQUIRED_OLDER_UPSTREAM_GATE_MISSING_OR_NOT_PASSED")
    if not evidence["aa0_policy_literal_accepted"]: return gate(BLOCKED_BY_DESCRIPTIVE_COUNT_VALUES_V0_POLICY_LITERAL, "AA0_POLICY_LITERAL_NOT_ACCEPTED")
...
def build_real_validation_receipt(
    *,
    ...
    if simulated_event_schema_lock_diagnostics is not None:
    ...
    if descriptive_statistical_metadata_rows_v0_diagnostics is not None:
        receipt["descriptive_statistical_metadata_rows_v0_diagnostics"] = (
            descriptive_statistical_metadata_rows_v0_diagnostics
        )
    if descriptive_statistical_value_policy_lock_aa0_diagnostics is not None:
        receipt["descriptive_statistical_value_policy_lock_aa0_diagnostics"] = (
            descriptive_statistical_value_policy_lock_aa0_diagnostics
        )
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.bars_dir is not None:
        ...
        try:
            ...
            economic_accounting_rows_v0_diagnostics = (
                _build_economic_accounting_rows_v0_diagnostics(
                    economic_output_schema_lock_diagnostics=economic_output_schema_lock_diagnostics,
                    simulated_events_v0_diagnostics=simulated_events_v0_diagnostics,
                    simulated_event_schema_lock_diagnostics=simulated_event_schema_lock_diagnostics,
                    materialized_rule_rows_v0_diagnostics=materialized_rule_rows_v0_diagnostics,
                    materialized_rule_row_schema_lock_diagnostics=materialized_rule_row_schema_lock_diagnostics,
            ...
            descriptive_count_values_v0_diagnostics = _build_descriptive_count_values_v0_diagnostics(
        ...
        try:
            ...
            descriptive_statistical_value_policy_lock_aa0_diagnostics = _build_descriptive_statistical_value_policy_lock_aa0_diagnostics(
                descriptive_statistical_metadata_rows_v0_diagnostics=descriptive_statistical_metadata_rows_v0_diagnostics,
                descriptive_statistical_value_schema_lock_z0_diagnostics=descriptive_statistical_value_schema_lock_z0_diagnostics,
                statistical_value_readiness_rows_v0_diagnostics=statistical_value_readiness_rows_v0_diagnostics,
                statistical_value_contract_lock_y0_diagnostics=statistical_value_contract_lock_y0_diagnostics,
